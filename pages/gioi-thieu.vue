    ...
    <div class="section-body">
      ...
      <div class="timeline">
        ...
        <p class="p p1">
          ...
          ngôi trường hạnh phúc yêu thương thuận tự nhiên, các con được học hỏi
          khám phá theo nhịp điệu theo phương pháp giáo dục steiner kết hợp với
          các giá trị truyền thống văn hóa của dân tộc Việt Nam nuôi dưỡng tình
          yêu từ trái tim mỗi trẻ, trẻ được hòa nhập vào cuộc sống cùng tình yêu
          thiên nhiên.
        </p>
        <p class="d d2">
          2021 <br />
        ...
        <p class="p p2">
          Trong giai đoạn này, trường đã triển khai được hoạt động đi vườn hàng
          tháng các con được ra ngoài dạo chơi với thiên nhiên, khám phá xúc
          chạm để sự trải nghiệm của trẻ như thật, nhà trường luôn cố gắng nỗ
          lực trong việc giúp trẻ được trải nghiệm, tự thân học hỏi, khám phá
          nhiều nhất có thể trong khả năng của mình. Và đưa ngoại ngữ với phương
          châm là một phương tiện học hỏi thứ 2 giúp các con hòa nhập với thế
          giới, thuận tự nhiên, các con học với giáo viên bản ngữ vui chơi với
          các vần điệu bài hát tự nhiên.
        </p>
        <p class="d d3">
          2022 <br />
          - <br />
